...
if exist "testFramework\com\testframework\model\*.java" (
    ...
    javac -classpath "build\classes" -d "build\classes" testFramework\com\testframework\model\*.java
    if errorlevel 1 (
...
if exist "testFramework\com\testframework\controller\*.java" (
    javac -classpath "jakarta.servlet-api_5.0.0.jar;build\classes" -d "build\classes" testFramework\com\testframework\controller\*.java
    if errorlevel 1 (
